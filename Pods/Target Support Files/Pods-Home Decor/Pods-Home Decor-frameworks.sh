...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/MGK3DButton/MGK3DButton.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SmshostingVerifyNumberOTP/SmshostingVerifyNumberOTP.framework"
